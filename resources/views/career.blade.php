          ...
          <div class="carousel-inner" role="listbox">
            ...
            <div class="carousel-item slides {{ $count == 1 ? 'active':''}}">
              ...
              <div class="row">
                <div class="container">
                  <div class="hero">
                      <div class="sidebar-logo" style="max-width: 138px; max-height: 113px; margin-left: 500px;"><img class="icon" data-animation="animated bounceInLeft" src="{{asset('storage/images/'.$datas->logo)}}" alt=""> </div> <div class="sidebar-content" style="margin-right: 500px;">  <h1>Careers</h1>
                      <div class="inner-breadcrumb">
                        <ul>
                          <li><a href="{{ '/' }}">Home</a></li>
                          <li> Careers</li>
