	...
	<main class="app-content">
		...
		<div class="app-title">
			...
			<ul class="app-breadcrumb breadcrumb">
				<span class="ml-2">
					<a href="{{route('platform-and-framework.create')}}" class="btn btn-outline-success">
					...
					<div class="card-body table-responsive">
						...
						<?php $count = 0; ?>
							...
							<tr class="text-center">
								...
								<td >
									<span>
										<a href="{{route('platform-and-framework.edit',$getDatas->id)}}" class="btn btn-sm btn-outline-warning"><i class="fa fa-edit"></i> Edit</a>
									</span>
									<span class="ml-2">
										<form  action="{{route('platform-and-framework.destroy',$getDatas->id)}}" method="POST" id="delform_{{ $getDatas->id}}">
												@csrf
											@method('DELETE')
