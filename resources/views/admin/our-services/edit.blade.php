...
@section('content')
	<main class="app-content">
		<div class="app-title">
			<div class="div">
				<h1><i class="fa fa-laptop"></i>Edit Our Services</h1>
			</div>
				...
				<div class="card shadow-xs">
					<div class="card-body">
						<div class="row form-group">								
							<form method="post" action="{{route('our-services.update',$data->id)}}" enctype='multipart/form-data'>
								@csrf
								@method('PATCH')
							...
							<div class="row">
								<div class="container">
							    	...
							    	<textarea class="form-control" id="summary-ckeditor" name="content" value="{{$data->content}}">{{$data->content}}</textarea>
